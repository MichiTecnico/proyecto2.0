...
if(isset($_POST['btn_registrar'])){
    ...
    $sql = "INSERT INTO personal(nacionalidad, cedula, fecha_nac, nombre, apellido, clave, id_rol, id_gerencia, id_division)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $con->prepare($sql);
    $stmt->bind_param(
        "sissssiii", $nacionalidad, $cedula, $fecha_nac, $nombre, $apellido, $clave, $id_rol, $id_gerencia, $id_division);

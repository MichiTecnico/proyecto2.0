<?php
// Puedes incluir conexión a tu BD si quieres mostrar datos dinámicos
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <table id="tablaMateriales">
      ...
      <tbody>
        <tr>
          ...
          <td><input type="number" name="cantidad[]" step="0.01" required></td>
          <td><input type="number" name="puntos[]" required></td>

...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid justify-content-between align-items-center">
    ...
    <div class="position-relative" style="left: -404px;"> <!-- Ajusta -50px a tu gusto -->
      <button id="btn_ingresar_cliente" class="btn btn-outline-success me-2">Cliente</button>
      <button id="btn_ingresar_personal" class="btn btn-outline-primary">Personal</button>
    </div>
  </div>
</nav>
<!--Barra de Navegacion (PARA EL LOGIN)-->
...
<main>
    <div class="contenedor__todo">
            ...
            <!--Cajas traseras (Son las que no se ven porque estan detras de los formularios)-->

            <div class="caja_trasera">
                <div class="caja_trasera-login_cli">
                    <h3>Eres parte de la familia Caracas Recicla?</h3>
                    <p>Ingresa tus datos y continua creciendo con nosotros.</p>
                    <br>"Mas que reciclar cambiamos vidas"</br>
                </div>
        ...
        <div class="contenedor_cliente-personal">        
            <form action="login.php" method="post" class="formulario_cliente">
                ...
                <button type="submit" name="btn_iniciar_cliente">Entrar</button>
            </form>

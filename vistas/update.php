    ...
    <form id="updateForm" action="../php/update_user.php?id=<?= $row['id']?>" method="POST">
        ...
        <div class="mb-3">
            <div class="input-group"> <!-- Contenedor unificado -->
                <!-- Select para V/E -->
                <select id="0" class="form-select" name="nacionalidad" style="max-width: 80px;" required>
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                <select class="form-select" name="id_gerencia" id="5" style="max-width: 500px;" required>
        ...
        <div class="mb-3">
            <select class="form-select" name="id_division" id="6" style="max-width: 500px;" required>
        ...
        <div class="mb-3">    
            <select class="form-select" name="id_rol" id="7" style="max-width: 500px;" required>
        ...
        <div class="mb- password-container">
            <input type="password" class="form-control" name="clave" id="8" value="<?= $row['clave']?>" placeholder="Inserte una contraseña" id="password" required autocomplete="off">

...
<head>
  ...
  <style>
    :root{--bg:#f5f7fb;--card:#ffffff;--accent:#2b8a6f;--muted:#6b7280}
    ...
    header{background:linear-gradient(90deg,#0f766e22,#2b8a6f11);padding:18px 28px;border-bottom:1px solid #e6eef0}
    ...
    .card{background:var(--card);border-radius:12px;padding:18px;box-shadow:0 6px 18px rgba(11,22,26,0.04);}
    .grid{display:grid;gap:18px}
    .grid-cols-3{grid-template-columns:1fr 2fr 1fr}
    .small{font-size:13px;color:var(--muted)}
    .btn{background:var(--accent);color:white;padding:8px 12px;border-radius:8px;border:none;cursor:pointer}
    .input{padding:8px 10px;border-radius:8px;border:1px solid #e6eef0;width:100%}
    ...
    .tag{display:inline-block;padding:4px 8px;border-radius:999px;background:#edf7f4;color:#044c3f;font-size:12px}
    .kit{background:#fff9ed;border-left:4px solid #f59e0b;padding:10px;border-radius:8px}
    ...
    .product-card{display:flex;justify-content:space-between;align-items:center;padding:10px;border-radius:8px;border:1px solid #edf2f7}
...
<body>
  <header>
    <div class="container brand">
      ...
      <div>
        <div class="logo-title">ECOINNOVA</div>
        <div class="small">Sistema de canje — prototipo visual</div>
      </div>
    </div>
  </header>  <main class="container">
    <div class="grid grid-cols-3">
      <!-- Panel izquierdo: login / usuario -->
      <div class="card">
        <h3>Acceso rápido</h3>
  ...
  <!-- Panel central: catálogo / historial -->
